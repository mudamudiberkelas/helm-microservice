...
class App extends Component {
  ...
  fetchData = () => {
    axios.get('http://172.29.146.90:5001/api/getallips').then(
      res => this.setState({ addresses: res.data })
    ).catch(error => {
      console.log('GET all ipaddresses:' + error)
    });

    axios.get('http://172.29.146.90:5001/api/isalive').then(
  ...
  saveToFlaskBackend = (e) => {
    ...
    axios.get('http://172.29.146.90:5001/api/saveip').then(
